        ...
        <Content>
           <div class="container">
               <div class="container-left">
                   <div >
                       <h1 class="title-choose"><Icon type="ios-radio-button-off" class="pointer" /><span v-bind:class="[chooseIndex <= 10 ? 'isClicked' : null]">师资团队</span></h1>
                       <div class="teacher-name">
                            <div  v-for="(item, index) in teachers" v-bind:key="item.name" @click="chooseTitle(index)">
               ...
               <div class="container-right" v-if="chooseIndex == 0">
                   ...
                   <p class="person-introduce">个人荣誉</p>
                   ...
                   <p class="person-context">9、广东工业大学教学优秀“一等奖”“二等奖”（4次）</p>
               ...
               <!-- 曾安 -->
                <div class="container-right" v-if="chooseIndex == 2">
                   ...
                   <p class=" person-page">
                    ...
                    <p class="person-context">
                        ZENG An, GAO Qi-gang, PAN Dan. A Global Unsupervised Data Discretization Algorithm based on Collective Correlation Coefficient. In: Proceedings of The 24th International Conference on Industrial, Engineering & Other Applications of Applied Intelligent Systems (IEA/AIE'11), Lecture Notes in Artificial Intelligence (LNAI), U.S.A, June 28- July 1, 2011.  
                    </p>
                    <p class="person-context">
                        Zeng An, Pan Dan, Zheng Qilun, Peng Hong, Knowledge Acquisition Approach Based on Rough Set and Principal Component Analysis, IEEE Intelligent Systems, Vol. 21, No. 2, 2006, pp. 78-85.
                    </p>
                    <p class="person-context">
                        Zeng An, Pan Dan, He Jian-bin, Prediction of MHC II-binding Peptides Using Rough Set-based Rule Sets Ensemble, Applied Intelligence，Vol.27, No.2, 2007, pp. 153-166.
                    </p>
                    <p class="person-context">
                        Pan Dan, Zheng Qilun, Zeng An, Hu Jin-song, A Novel Self-Optimizing Approach for Knowledge Acquisition, IEEE Transactions on Systems, Man And Cybernetics- Part A: Systems and Humans, Vol.32, No.4, July 2002, pp. 505-514.
                    </p>
                    <p class="person-context">
                        曾安, 郑启伦, 潘丹, 彭宏. 基于排序学习前向掩蔽模型的快速增量学习算法. 电子学报. 2004, Vol.32, No.12, pp.2051-2055.
                    </p>
                    <p class="person-context">
                        Zeng An, Pan Dan, He Jian-bin, Yu Yong-quan., A Rule Sets Ensemble for Predicting MHC II-Binding Peptides, In: Proceedings of The 19th International Conference on Industrial, Engineering & Other Applications of Applied Intelligent Systems (IEA/AIE'06), Lecture Notes in Artificial Intelligence (LNAI 4031), Annecy, France, June 27-30, 2006, pp. 353-362.
                    </p>
                    <p class="person-context">
                        Zeng An, Pan Dan, Yu Yong-quan, Zeng Bi, Rule Induction for Prediction
                    </p>
                    <p class="person-introduce">学术活动</p>
                    <p class="person-context">
               ...
               <div class="container-right" v-if="chooseIndex == 3">
                   ...
                   <p class=" person-page">
                    ...
                    <p class="person-introduce">学术活动</p>
                    <p class="person-context">
                        2011.01-now,广东省高端厨房电器企业重点实验室负责人
                    </p>
                     <p class="person-introduce">主要论文</p>
                    <p class="person-context">
                        （包括：代表性著作及论文、获奖及专利等）在国内外期刊发表论文多篇
                    </p>
                     <p class="person-introduce">教学信息</p>
                    <p class="person-context">
                        《操作系统》，《C程序设计》 隶属于计算机学院网络空间安全系
                    </p>
                    <p class="person-context">
                        为本科生和研究生讲授了下面的课程：软件工程，软件需求分析，数据库，计算机网络，操作系统，数据结构，网络安全，计算机原理，分布式操作系统与实时操作系统，计算机系统的建模与分析，实时系统，计算机高新技术
                    </p>
                     <p class="person-introduce">科研项目</p>
                    <p class="person-context">
                        新型通道式安检机的关键技术研究及其产业化,省部产学研结合项目,项目编号：2012B091100497，下达文号：粤财教[2012]393号，下达单位：广东省科技厅，项目起止时间：2012.7.1-2014.12.31，
                    </p>
                    <p class="person-context">
                        厨房生活垃圾处理器关键技术研究及其产业化,广东省重大科技专项项目,项目编号：2012A080103010，下达文号：粤科规划字[2012]99号，下达单位：广东省科技厅，项目起止时间：2012.3.1-2014.12.31，项目经费：120万元，主持。
                    </p>
                    <p class="person-context">
                        全自动大型高效节能纸箱印刷开槽模切生产线成套设备关键技术的研发及其产业化 ,广东省粤港关键领域重点突破项目,项目编号：2012A080107007，下达文号：粤科高字[2012]197号，下达单位：广东省科技厅，项目起止时间：2012.10.1-2014.12.31，项目经费：150万元，校方主持人。
                    </p>
                    <p class="person-context">
                        不锈钢制品抛光机器人的研制及其产业化,省部产学研结合项目,项目编号：2012B091100191，下达文号：粤财教[2012]393号，下达单位：广东省科技厅，项目起止时间：2012.5.1-2014.12.31，项目经费：50万元，主持。
                    </p>
                    <p class="person-context">
                       广东省高端厨房电器技术企业重点实验室，广东省企业重点实验室建设项目，项目编号：2011A091000046，下达文号：粤财教[2011]508号，下达单位：广东省科技厅，项目起止时间：2011.3.1-2013.2.28，项目经费：100万元，主持。
                    </p>
                    <p class="person-context">
                        五华县棉洋水果专业镇技术创新服务平台建设，专业镇中小微企业公共服务平台建设工程，项目编号：2012B091400020， 下达单位：广东省科技厅，项目经费：50万，项目起止时间：2013.01.01-2014.12.31,校方主持。
                    </p>
                    <p class="person-introduce">研究兴趣</p>
               ...
               <!-- 陈云华 -->
                <div class="container-right" v-if="chooseIndex == 5">
                   ...
                   <p class=" person-page">
                    ...
                    <p class="person-introduce">工作经历</p>
                    <p class=" person-page">
                        2003/09至今，广东工业大学大学计算机学院教师<br>

                    </p>
                    <p class="person-introduce">主要荣誉</p>
                    <p class="person-context">
                        中国软件行业协会嵌入式系统分会中国嵌入式系统产业联盟“嵌入式Linux系统开发最具潜力讲师”
                    </p>
                    <p class="person-context">
                        “粤嵌杯”广东省大学生嵌入式与物联网设计大赛“一等奖”
                    </p>
                    <p class="person-context">
                        广东工业大学教学优秀“二等奖”
                    </p>
                    ...
                    <p class="person-page">
                        ...
                        一种改进的双群进化规划算法，计算机工程，2010.<br>
                        11.Extension evaluation method and its application in waste organic gas treatment.Proceedings of ACTEA 2009.<br>
                        12.Extension detecting technology and the implementing method for its application in engineering.Proceedings of ICMLC 2009.<br>
                        13.Application of granular computing in extension criminal reconnaissance system.Proceedings of GrC 2007.<br>
                        14.一种基于新型遗传算法的块运动估计算法，计算机工程与应用，2005.<br>
                        15.一种结合时域信息的量化误差模型，微机发展，2004.<br>
                    ...
                    <p class="person-introduce">知识产权</p>
                    <p class="person-page">
                        面部特征点快速定位方法，中国，201410487599.6<br>
                        一种面向社区医疗服务的智能手持终端，中国，CN203290884 U<br>
                        驾驶疲劳检测和预警软件(原始取得)，登记号：2014SR020060<br>
               ...
               <!-- 林伟 -->
                <div class="container-right" v-if="chooseIndex == 6">
                   ...
                   <p class=" person-page">
                    ...
                    <p class="person-introduce">主要论文</p>
                    <p class="person-page">
                        "高速图像采集和传输系统设计"《现代计算机》2009-12<br>
                        "Adaptive Neural-based Fuzzy Inference System Approach applied to Steering Control"《Lecture Notes in Computer Science》2009.5<br>
                        "基于物理层隔离的单向文件轮渡系统的设计及应用"《计算机安全》2009.1<br>
                        "基于AVR的长度自动测量系统的设计"《微计算机信息》2009.1<br>

                    </p>
                    <p class="person-introduce">科研项目</p>
                    <p class="person-context">
                        《廉价单片机原理及应用》，北京航空航天大学出版社
                    </p>    
                    <p class="person-context">
                        《单片微型机原理及开发应用》，广东高等教育出版社
                    </p> 
                    <p class="person-introduce">研究兴趣</p>
                    <P class="person-context">
                        智能高效节能多功能电控压力锅的研制及产业化（省部级产学研）<br>
                        电力制造设备研究与开发<br>
                        企业ERP管理软件开发。<br>
                        广东省南方电力局培训管理系统设计<br>
                        基于ARM嵌入式技术视觉定位系统设计<br>
                        LonWork网络系统应用设计<br>
                        LonWork智能节点设计<br>
                        智能家居网络系统设计<br>
                        工厂自动化控制系统设计<br>
               ...
               <!-- end孙宣东  -->
                ...
                <div class="container-right" v-if="chooseIndex == 10">
                   ...
                   <p class=" person-page">
                    ...
                    <p class="person-context">
                        目前在研课题包括：本人负责的1项国家自然科学基金面上项目(2017~2020)和2项广东省自然科学基金项目。曾参与多项国家自然科学基金项目的研究工作。主持或作为技术负责人完成了多个企业web信息系统、网络安全软件的研究与开发。
                    </p>
                    <p class="person-context">在IEEE Transactions等期刊、IEEE国际会议上发表10多篇论文(均被SCI或EI检索)。</p>
                    <p class="person-context">研究领域：优化调度（半导体制造、云计算）、离散事件系统、Petri网理论及应用。</p>
                    <p class="person-context">代表成果：发现半导体芯片制造系统(multi-cluster tools)存在1-晶圆(1-wafer)调度及其存在的充要条件，提出了求解能达生产周期下界的1-晶圆周期调度的高效算法。</p>
                    <p class="person-introduce">学术兼职</p>
                    <p class="person-page">
                        担任如下期刊的审稿人：<br>
                        IEEE Transactions on Semiconductor Manufacturing (SCI检索),<br>
                        Journal of Intelligent Manufacturing (SCI检索) ,<br>
                        IEEE Access (SCI检索) ,<br>
                        IEEE/CAA Journal of Automatica Sinica (SCI检索) ,<br>
                        控制理论与应用 (EI检索)。<br>
                        担任波兰国家自然科学基金OPUS项目评审员。<br>
                        担任如下国际会议的分会主席/程序委员会(PC)成员或技术委员会成员：<br>
               ...
               <!-- end朱清华   -->
                ...
                <div class="container-right" v-if="chooseIndex == 11">
                   ...
                   <p class="person-introduce">教育背景</p>
                   <p class=" person-page">
                        粤教高函[2012]204号	计算机专业基础课程群的实验平台创新与内容体系优化	吴伟民	计算机学院	省级<br>
                        广工大教字〔2015〕132号	以挑战杯竞赛为平台培养大学生创新能力的探索和研究	谢光强	计算机学院	校级<br>
                        广工大教字〔2013〕116号	计算机专业学生课外科技活动中实践创新能力培养的研究与探索	谢光强	计算机学院	校级<br>
                        广工大教字〔2013〕116号	计算机专业核心课程群自主学习平台下教与学新型模式研究与实践	李杨	计算机学院	校级<br>
                        广工大教字〔2012〕154号	计算机专业基础课程群的实验平台创新与内容体系优化	吴伟民	计算机学院	校级<br>
                        广工大教字〔2010〕186号	数据结构与程序设计可视化实验平台和教学模式的改革与创新	吴伟民	计算机学院	校级<br>
               ...
               <!-- 教师竞赛获奖-->
                <div class="container-right" v-if="chooseIndex == 12">
                   ...
                   <p class=" person-page">
                        1 2017 广东省教育教学成果奖（高等教育）“一等奖”（排名第八）<br>
                        2 2016 广东省第五届师德征文活动“二等奖”<br>
                        3 2012 广东省第一届高等院校青年教师教学基本功大赛 “优秀奖”<br>
                        4 2017 广东工业大学“师德标兵”<br>
                        5 2009 广东工业大学“十佳授课教师”<br>
                        6 2007 广东工业大学“学生最喜爱的教师”<br>
                        7 2012 广东工业大学“年度优秀教师”<br>
                        8广东工业大学教学优秀“一等奖”（5次）、<br>
                        9广东工业大学教学优秀“一等奖”“二等奖”（4次）<br>
                        9 2010 云浮市“科学技术奖二等奖”（排名第二）<br>
                        10 2013 广东工业大学“科研工作先进者”<br>
                        11 2011 广东工业大学“优秀指导老师”<br>
                        12广东工业大学“优秀班主任”（2005-2008，2017）<br>
                        13 2007 计算机学院“师德先进个人”<br>
                        14 2009 广东工业大学“大学毕业生就业工作先进个人”<br>
                        15 2015 广东工业大学“优秀工会积极分子”<br>
                        16 2008年-2018年 进行毕业设计指导时，为学生选择高质量和有创新性的题目，耐心指导，连续十一年指导学生获得“毕业设计指导创新奖”<br>
                        17 2016-2017-1学期所讲授的《程序设计》课程，学生评教得分名列全校第一，评教分数连续六年学院排名第一。<br>
                    </p>
